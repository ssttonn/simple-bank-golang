...
func TestTransferTx(t *testing.T) {
	// Ensure testDB is initialized before use
	require.NotNil(t, testDB, "testDB must be initialized before running tests")
	...
	for range n {
		...
		fmt.Println(k, "->", fromAccount.Balance, toAccount.Balance)
	}
